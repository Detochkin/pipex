...
/*   Updated: 2021/12/25 16:05:48 by dirony           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex_bonus.h"

t_list	*create_tail(int fd)
{
	t_list	*result;
...
char	*get_line_from_string(t_list *tail)
{
	char	*p_newline;
	char	*result;
	char	*temp;
...
int	read_from_file(t_list *tail)
{
...
char	*check_result(char *result, t_list **first_elem)
{
	t_list	*tail;
